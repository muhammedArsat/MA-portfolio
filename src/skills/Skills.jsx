...
const Skills = () => {
    return (
        <div className="  xl:min-h-dvh mb-5 mt-10" id='skills'>
            <h1 className="w-full text-center text-3xl mt-10 relative after:content-[''] after:absolute after:bottom-[-10px] md:after:top-11 after:left-1/2 after:transform after:-translate-x-1/2 after:w-16 after:h-1 after:rounded-lg after:bg-green-300">
                Skills
            </h1>

            <div className="grid mt-12 grid-cols-2 gap-4 md:grid-cols-3 md:gap-y-4 lg:grid-cols-4 lg:gap-y-10 m-4">
                <div className="flex justify-between lg:justify-evenly items-center shadow-lg  py-4 px-4 hover:border hover:border-green-400 transition-colors rounded-lg">
                    <h1>C </h1>
                    <img
